    ...
    var body: some View {
        ZStack {
            ...
            VStack(spacing: 10) {
                ...
                CustomTextField(placeholder: "Password", text: $password, isSecure: false) // Secure
                ...
                CustomTextField(placeholder: "Confirm Password", text: $confirmPassword, isSecure: false) // Secure
                ...
                Button(action: {
                    ...
                    if let emptyFieldError = checkForEmptyFields() {
                ...
                .opacity(isLoading ? 0.6 : 1.0) // Reduce opacity when disabled
    ...
    private func createAccount() {
        ...
        Auth.auth().createUser(withEmail: email, password: password) { authResult, error in
            if let error = error {
                ...
                DispatchQueue.main.async {
                    // Optionally, handle specific Firebase errors here
            ...
            uploadProfileImage(profileImage, uid: "\(uid)") { result in
                ...
                case .failure(let error):
                    ...
                    DispatchQueue.main.async {
                        ...
                        passwordError = "Failed to upload profile image."
                        isLoading = false
                    }
                }
            }
